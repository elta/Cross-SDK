...
export ELFUTILS_VERSION=0.148
export ELFUTILS_SUFFIX=${BZ}
export ELFUTILS_URL=https://fedorahosted.org/releases/e/l/elfutils
...
export LIBICONV_SUFFIX=${GZ}
export LIBICONV_URL=http://ftp.gnu.org/pub/gnu/libiconv
export LIBELF_VERSION=0.8.13
export LIBELF_SUFFIX=${GZ}
export LIBELF_URL=http://www.mr511.de/software
...
export PERLCROSS_URL=http://sourceforge.net/projects/perlcross.berlios/files
...
export PREFIXHOSTTOOLS=${PREFIX}/host-tools
...
export METADATAHOSTTOOLS=${METADATA}/host-tools
...
export SRCHOSTTOOLS=${SRC}/host-tools
