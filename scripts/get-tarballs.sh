...
export LIBESTR_VERSION=0.1.0
export LIBESTR_SUFFIX=${GZ}
export LIBESTR_URL=http://sourceforge.net/projects/libestr/files
...
export LLVM_URL=http://llvm.org/releases/3.1
export CLANG_VERSION=3.1.src
export CLANG_SUFFIX=${GZ}
export CLANG_URL=http://llvm.org/releases/3.1
export CRT_VERSION=3.1.src
export CRT_SUFFIX=${GZ}
export CRT_URL=http://llvm.org/releases/3.1
